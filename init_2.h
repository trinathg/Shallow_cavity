...
const double dt = 5.0e-6; //CFL_d*(dx)*(dx)*Re; // 1/Re acts as a diffusion coefficient here 

const double tot_time = 1.5; //Some-non-dimenisonal time 
...
const int restart=1; //0 --> No restart; 1->Restart
